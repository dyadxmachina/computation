...
def test_play_hand(word_list):
    ...
    # print(hand)
    if play_hand(hand,word_list) != 24:
        print "FAILURE: play_hand()"
        print "\tExpected 24, but got {score} for word: {word} ".format(score=play_hand(hand,word_list),word=word)
